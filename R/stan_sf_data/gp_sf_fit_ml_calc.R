...
log.prior = dinvgamma(alpha.restricted, shape = alpha_prior_shape, rate = alpha_prior_rate, log = TRUE) +
  sum(dinvgamma(H.inv.diag.restricted, shape = H_inv_diag_prior_shape, rate = H_inv_diag_prior_rate, log = TRUE)) +
