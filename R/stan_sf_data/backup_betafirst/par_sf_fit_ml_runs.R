...
for (k.restricted in 1:(ncol(X) - 1)){
  ...
  save(stan.fit, file = sprintf("stan_par_fits/stan_par_sf_restr_beta_partial_%i.RData", k.restricted))
}
...
save(stan.fit, file = "stan_par_fits/stan_par_sf_restr_beta.RData")
...
save(stan.fit, file = "stan_par_fits/stan_par_sf_restr_beta_beta_const.RData")
...
save(stan.fit, file = "stan_par_fits/stan_par_sf_restr_beta_beta_const_sigma_v.RData")
